...
public class Page<T> implements Iterable<T> {
  ...
  public String toString() {
    ...
    return String.format(
        "Offset %d containing %d %s instances",
        this.pageable.getOffset(), this.pageable.getLimit(), contentType);
  }
  ...
  public boolean equals(Object o) {
    if (this == o) {
      ...
      return (new EqualsBuilder())
          .append(this.total, page.total)
          .append(this.content, page.content)
          .append(this.pageable, page.pageable)
          .isEquals();
    }
  }
